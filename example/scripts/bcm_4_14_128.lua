...
function dump_mem_0x8000_0x716480()
	file = io.open("/home/jmh/ecmo/result/4.14.128/bcm/55514_chk_unpack/55514_kernel","wb")
	buf = lua_read_mem(0x8000,0x716480)
	file:write(buf)
	file:close()
	lua_continue()
end
...
function change_pointers()
	lua_write_dword(0xc0623268,0xd00008a0)
	lua_write_dword(0xc062326c,0xd0000bf4)
	lua_write_dword(0xc062323c,0)
	lua_write_dword(0xc0623240,0)
	lua_write_dword(0xc0623244,0)
...
function post_init()
	lua_load_file("driver/bcm_4_14_128_ecmo.o",0xd0000000)
